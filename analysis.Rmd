...
correlation_accuracy= cor(test_df$n_killed, y_pred); correlation_accuracy # relatively nice percentage 
mape = mean(abs((y_pred - test_df$n_killed))/test_df$n_killed); mape # very small 
rmse = rmse(test_df$n_killed, y_pred); rmse # small relative to number of deaths in a year
```
